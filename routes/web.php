...
// Route::post('/tambah-pengeluaran', [BudgetingController::class, 'tambahPengeluaran'])->name('tambah.pengeluaran');
...
// Route::post('/pengeluaran', [PengeluaranController::class, 'simpan'])->name('pengeluaran.simpan');
